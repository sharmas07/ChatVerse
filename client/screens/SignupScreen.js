  ...
  return (
    <View style={{
      ...
      <KeyboardAvoidingView>
        ...
        <Pressable onPress={handleRegister} style={{width:200, backgroundColor:"black", padding:15, marginTop:50, marginLeft:'auto', marginRight:'auto', borderRadius:10}}>
          <Text style={{color:"white", fontSize:16,textAlign:'center', fontWeight:600}}>Sign Up</Text>
        </Pressable>
